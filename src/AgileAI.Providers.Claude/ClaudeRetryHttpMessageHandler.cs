...
public class ClaudeRetryHttpMessageHandler : DelegatingHandler
{
    private readonly ClaudeOptions _options;
    private readonly ILogger<ClaudeRetryHttpMessageHandler>? _logger;

    public ClaudeRetryHttpMessageHandler(ClaudeOptions options, ILogger<ClaudeRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
