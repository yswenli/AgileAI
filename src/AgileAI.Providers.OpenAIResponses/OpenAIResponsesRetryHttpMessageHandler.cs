...
public class OpenAIResponsesRetryHttpMessageHandler : DelegatingHandler
{
    private readonly OpenAIResponsesOptions _options;
    private readonly ILogger<OpenAIResponsesRetryHttpMessageHandler>? _logger;

    public OpenAIResponsesRetryHttpMessageHandler(OpenAIResponsesOptions options, ILogger<OpenAIResponsesRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
